...
export const userActions = {
  ...
  delete: createAsyncThunk("users/deleteusers", async (id) => {
    try {
  ...
  postDate: createAsyncThunk("date/postdate", async (date) => {
    try {
      let response = await axios.post("/date", date);
  ...
  getDate: createAsyncThunk("date/getDate", async () => {
    try {
